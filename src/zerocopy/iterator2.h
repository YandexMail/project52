...
#ifndef _YAMAIL_DATA_ZEROCOPY_ITERATOR2_H_
#define _YAMAIL_DATA_ZEROCOPY_ITERATOR2_H_
...
class iterator2 : public boost::iterator_facade <
  iterator2<Value, Fragment, SegmentSeq>,
  Value const,
...
public:
  iterator2() : fragment_list_ (0), after_last_frag_ (false) {}

  iterator2 (fragment_list const& segm_seq,
...
private:
  ...
  bool equal (iterator2 const& other) const
  {
...
#endif // _YAMAIL_DATA_ZEROCOPY_ITERATORi2_H_
